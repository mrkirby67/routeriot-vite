...
function teardownPlayerListeners(reason = 'manual') {
  ...
  speedBumpOverlayCleanup?.(reason);
  speedBumpOverlayCleanup = null;
  ...
  teamSurpriseCleanup?.(reason);
  teamSurpriseCleanup = null;
...
function handleLiveGameState(state) {
  ...
  switch (status) {
    ...
    case 'ended':
      ...
      hidePausedOverlay();
      showFlashMessage('🏁 Game has concluded.', '#c62828', 2400);
      break;
